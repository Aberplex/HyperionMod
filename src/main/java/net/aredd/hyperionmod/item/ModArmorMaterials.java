...
public enum ModArmorMaterials implements ArmorMaterial {
    HYPERIONITE("hyperionite", 25, new int[] {6, 12, 10, 6}, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4f, 0f, () -> Ingredient.ofItems(ModItems.HYPERIONITE_INGOT))
    ;
    ...
    public String getName() {
        return HyperionMod.MOD_ID + ":" + this.name;
    }
